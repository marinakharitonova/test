...
Selectize.define("no_results", (function (e) {
    ...
    this.onBlur = (e = t.onBlur, function () {
        this.$control_input.removeClass("active"), this.$dropdown.parent().removeClass("active"), this.$dropdown.addClass("hidden"), e.apply(t, arguments)
        ...
        var e = t.removeItem;
        return function () {
            this.$control_input.removeClass("active"), this.$dropdown.addClass("hidden"), this.$dropdown.parent().removeClass("active"), e.apply(t, arguments)
        }
    }()
}));
var SelectizeSelect = function () {
    ...
    return _createClass(e, [{
        ...
        key: "open", value: function () {
            this.selectize.$control_input.addClass("active"), this.selectize.focus(), this.selectize.$dropdown.removeClass("hidden"), this.selectize.$dropdown.parent().addClass("active")
        }
    }]), e
}();
